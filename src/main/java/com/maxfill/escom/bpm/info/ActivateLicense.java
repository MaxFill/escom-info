...
import com.maxfill.escom.bpm.info.model.License;
import com.maxfill.escom.bpm.info.model.LicenseFacade;
...
public class ActivateLicense{
    private static final Logger LOGGER = Logger.getLogger(ActivateLicense.class.getName());
    ...
    public String onMessage(String json) {
        ...
        lc.setLicensor("Ромашка ООО");
        lc.setName("Стандартная");
        lc.setNumber("111");
        lc.setTotal(10);
        licenseFacade.create(lc);

        /*System.out.println("license=" + json);
